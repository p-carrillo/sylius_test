...
use Sylius\Component\Customer\Model\Newsletter;
use Sylius\Component\Customer\Model\NewsletterInterface;
                            ...
                            ->addDefaultsIfNotSet()
                                ->children()
                                    ...
                                    ->arrayNode('classes')
                                        ...
                                        ->scalarNode('interface')->defaultValue(NewsletterInterface::class)->cannotBeEmpty()->end()
                                        ->scalarNode('controller')->defaultValue(ResourceController::class)->cannotBeEmpty()->end()
                                        ->scalarNode('repository')->cannotBeEmpty()->end()
                                        ->scalarNode('factory')->defaultValue(Factory::class)->end()
//                                        ->scalarNode('form')->defaultValue(NewsletterFormType::class)->cannotBeEmpty()->end()
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
